...
//--------------------------------------------------
// YOUR NAME: Mohamed Riadh Ghellab
//--------------------------------------------------
...
void tracePath(state goal)
{
  ...
  // using cameFrom's  -- recursion would be useful
}// end of tracePath
...
void generate(state next)
{
  ...
  // You may write a utility function for this and call it

  // *** if unsafe, do not add to frontier.
  // You may write a function for this and call it
